...
with open(BASEPATH + "dual_res.json", "w") as f:
...
with open(BASEPATH + "sep_conv_policy.json", "w") as f:
    f.write(sep_conv_policy_json)
sep_conv_value_json = sep_conv_value.to_json()
with open(BASEPATH + "sep_conv_value.json", "w") as f:
